    ...
    Doc Qa Bot 3gz7t
    ================
    A Python-based AI utility that rewrites text using modern language model APIs.
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="A Python-based AI utility that rewrites text using modern language model APIs.")
